...
public class ConsoleAspectJ {
	...
	@Before("execution(void es.capgemini.proyecto.negocio.metodos.Metodos.Metodo1())")
	public void antesMetodo1(JoinPoint point) {
		System.out.println("Ejecutando metodo 1");
	}
	
	
	@After("execution(void es.capgemini.proyecto.negocio.metodos.Metodos.Metodo1())")
	public void despuesMetodo1(JoinPoint point) {
		System.out.println("Ejecutado metodo 1");
	}
	
	@Before("execution(void es.capgemini.proyecto.negocio.metodos.Metodos.Metodo2())")
	public void antesMetodo2(JoinPoint point) {
		System.out.println("Ejecutando metodo 2");
	}
	
	
	@After("execution(void es.capgemini.proyecto.negocio.metodos.Metodos.Metodo2())")
